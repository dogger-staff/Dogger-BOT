...
const submit_order_delay = document.querySelector('#submit_order_delay'); // 新增
...
async function saveChanges() {
    ...
    if (!ticket_number_value) {
        ...
        if (settings) {
            ...
            settings.advanced.submit_order_delay = Number(submit_order_delay.value); // 新增
...
function loadChanges() {
    storage.get('settings', function (items) {
        if (items.settings) {
            ...
            submit_order_delay.value = settings.advanced.submit_order_delay;
